...
<body id="<?php echo $this->fetch('body_id');?>">
  <header id="header" class="l-header">
    <h1 class="l-header__logo"><a href="/" title="trang chủ teratail"><img src="/img/sp/common/ttlHeader.png" alt="teratail"></a></h1>
  </header>
  ...
  <footer id="footer" class="l-footer">
      <?php echo $this->Element('Mobile/footer_static');?>
  </footer>
  <div id="debugger">
