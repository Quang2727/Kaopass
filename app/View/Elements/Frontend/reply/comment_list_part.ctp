...
<div class="<?php echo $class; ?>">
    <div class="boxCommentContent arrow_box_b markdown-area question-preview">
        <p class="boxItemContentDetail question-preview"><?php echo $comment_data["comment"]; ?></p>
    </div>
    <dl class="boxStat clearFix">
        <dt class="boxStatThumb floatL">
            <p class="boxRadius_22"> <img class="icnUserThumb_22" alt="Hình đại diện" src="<?php echo $img_src_for_comment; ?>"> </p>
        </dt>
 ...
 <?php if($isAdministrator) {?>
                   <p class="txtPostscript floatL"><?php echo $this->Html->link('Xoá bình luận câu trả lời',
                                   array('controller' => 'questions', 'action' => 'deletereplycomment', $comment_data['id']));?>&nbsp;&nbsp;</p>
                   <p class="txtPostscript floatL"><?php echo $this->Html->link('Thay đổi bình luận câu trả lời',
                                   array('controller' => 'questions', 'action' => 'editreplycomment', $comment_data['id']));?></p>
 <?php } ?>
</div>
